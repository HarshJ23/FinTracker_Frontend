...
export default function Register() {
  ...
  const submitHandler = async (e)=>{
    ...
    try {
      ...
      const {data} =  await axios.post("https://fintracker.onrender.com/api/v1/users/register" , {
        name , email , password
      }  ,{
        headers : {
  ...
  return (
    ...
    <div className="mt-6 ">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 z-1">
    ...
    <div className='form-control'>
           ...
           <p>Name</p>
              <input type="text" placeholder="Name" className="input input-bordered shadow-xl focus:outline-indigo-900 " 
